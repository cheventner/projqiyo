...
class TB_Optin_Module extends Themify_Builder_Component_Module {
	...
	public function get_options() {
		...
		return array(
			...
			self::get_seperator( __( 'Layout', 'themify' ) ),
			array(
				'id' => 'layout',
				'type' => 'layout',
			...
			self::get_seperator( __( 'Labels', 'themify' ) ),
            array(
				'type' => 'multi',
			...
			self::get_seperator( __( 'Success Action', 'themify' ) ),
			array(
				'id' => 'success_action',
				'type' => 'radio',
				...
				'options' => array(
					...
					array( 'value' => 's1', 'name' => __( 'Redirect to a new URL', 'themify' ) ),
				),
				'option_js' => true,
			),
			array(
			...
			<form class="tb_optin_form" name="tb_optin" method="post">
				<# if ( ! data.fname_hide ) { #>
					<div class="tb_optin_fname">
						<label class="tb_optin_fname_text">{{{ data.label_firstname }}}</label>
                        <input type="text" name="tb_optin_fname" required="required" <# if(undefined !== data.fn_placeholder && '' !== data.fn_placeholder){ #> placeholder="{{ data.fn_placeholder }}" <# } #> />
					</div>
				<# } #>
				<# if ( ! data.lname_hide ) { #>
					<div class="tb_optin_lname">
						<label class="tb_optin_lname_text">{{{ data.label_lastname }}}</label>
						<input type="text" name="tb_optin_lname" required="required" <# if(undefined !== data.ln_placeholder && '' !== data.ln_placeholder){ #> placeholder="{{ data.ln_placeholder }}" <# } #> />
					</div>
				<# } #>
				<div class="tb_optin_email">
					<label class="tb_optin_email_text">{{{ data.label_email }}}</label>
					<input type="email" name="tb_optin_email" required="required" <# if(undefined !== data.email_placeholder && '' !== data.email_placeholder){ #> placeholder="{{ data.email_placeholder }}" <# } #> />
				</div>
...
Themify_Builder_Model::register_module( 'TB_Optin_Module' );
