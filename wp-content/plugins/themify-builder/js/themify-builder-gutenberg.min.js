...
tb_app.vent.trigger("backend:switchfrontend",tb_app.redirectFrontend)}};a.registerBlockType("themify-builder/canvas",{title:"Themify Builder",icon:"layout",category:"layout",useOnce:!0,edit:function(b){a.builderUtils.vent.trigger("edit",b);return f("div",{id:"tb_canvas_block",tabIndex:-1},"placeholder builder")},save:function(){return null}});e=_.debounce(function(b){a.builderUtils.saveHTML(b);a.builderUtils.restoreHTML(b);a.builderUtils.manageState(b)},800);c=_.debounce(function(){a.builderUtils.saveBlock()},
