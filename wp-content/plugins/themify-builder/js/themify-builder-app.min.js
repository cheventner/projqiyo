...
d[0]),g[0].className+=" tb_element_clicked",b.ActionBar.type="subrow";else{var k=d.next(".tb_holder");0<k.length?k.prepend(g):(k=d.prev(".tb_holder"),k.append(g))}if(c){e=g.next(".module_row");var h=!0;0===e.length&&(h=!1,e=g.prev(".module_row"));e=e.data("cid");f="grid_sort"}b.Utils.setCompactMode(g[0].getElementsByClassName("module_column"));b.Mixins.Builder.update(g);d.remove();b.hasChanged=!0;k=g.closest(".module_row");c||k.removeClass("tb_row_empty");k.find(".tb_row_grid").remove();b.Utils.scrollToDropped(g[0]);
b.undoManager.push(k.data("cid"),e,k,f,{next:h})}else d.remove()},rowDrop:function(a,d,c,e){function f(){var a=d.prev(".module_row");if(0===a.length){var c="visual"===b.mode?d.closest(".themify_builder_content").data("postid"):null;a=!1}else a=a.data("cid");d[0].innerHTML="";b.ActionBar.type="row";d[0].parentNode.replaceChild(k,d[0]);b.hasChanged=!0;b.Instances.Builder[b.builderIndex].removeLayoutButton();b.undoManager.push("","","","predesign",{prev:a,rows:h,bid:c});a=0;for(c=h.length;a<c;++a){var e=
h[a][0].getElementsByClassName("module_column");0===a&&h[a][0].classList.add("tb_element_clicked");b.Utils.setCompactMode(e);b.Mixins.Builder.update(h[a])}b.Utils.scrollToDropped(h[0][0]);n.showLoader("hide");b.Utils.calculateHeight()}b.ActionBar.clear();var g=function(a){for(var b in a)if(a[b].styling&&0<Object.keys(a[b].styling).length||a[b].modules&&0<Object.keys(a[b].modules).length)return!0;return!1},k=r.createDocumentFragment(),h=[],m=[];e||b.Utils.clearLastEmptyRow(a);e=0;for(var q=a.length;e<
q;++e)if(!0===c||a[e].styling&&0<Object.keys(a[e].styling).length||a[e].cols&&g(a[e].cols)){var p=b.Views.init_row(a[e]);if(!1!==p){p=p.view.render();k.appendChild(p.el);if("visual"===b.mode){var y=p.el.querySelectorAll("[data-cid]");m[p.el.dataset.cid]=1;e=0;for(q=y.length;e<q;++e)m[y[e].dataset.cid]=1}h.push(p.$el)}}"visual"===b.mode?(b.bootstrap(m,f),m=null):f()},moduleDrop:function(a,d,c){function e(e){function f(e){k||h.model.set({is_new:1},{silent:!0});e=!0===e?h.model.getPreviewSettings():
...
n.Lightbox.open(d,null,function(){var d=this.$lightbox,f=d[0].querySelector("#custom_css");f.value=A;f.addEventListener("input",function(){var a=this.value.trim();if("visual"===b.mode){var c=r.getElementById("tb_custom_css_tmp");null===c&&(c=r.createElement("style"),c.type="text/css",c.id="tb_custom_css_tmp",r.head.appendChild(c));c.innerHTML=a}});d.addClass("tb_custom_css_lightbox").find(".builder_save_button").one("click",function(a){a.stopImmediatePropagation();a.preventDefault();A=f.value.trim();
n.Lightbox.close()});this.setStandAlone(a.clientX,a.clientY);v.body.one("themify_builder_lightbox_close",function(){A||(A="",c.classList.add("tb_tooltip_active"));var a=r.getElementById("tb_custom_css_tmp");a&&(a.innerHTML=A);c=null;u.document.body.classList.remove("tb_standalone_lightbox")})})},Revisions:{init:function(){b.toolbar.$el.find(".tb_revision").on("click",this.revision.bind(this))},revision:function(a){a.preventDefault();a.stopPropagation();a.currentTarget.classList.contains("tb_save_revision")?
...
n.Lightbox.close();b.undoManager.push("","","","import",{before:g,after:a,bid:themifyBuilder.post_ID})})}else n.showLoader(e),a=this.getOption().container.closest(".tb_input"),e=a.getElementsByClassName("tb_uploader_input")[0],a=a.getElementsByClassName("thumb_preview")[0],e.value=f.large_url?f.large_url:f.url,a!==t&&ThemifyConstructor.file.setImage(a,f.thumb),v.triggerEvent(e,"change")});l.init();k.classList.remove("plupload-clone")}}},columnDrag:function(a,d,c,e){var f=this;d&&(d=a?a.children(".module_column"):
h(".module_column"),d.css("width",""),f.setCompactMode(d));if(c&&e){a=a.children(".module_column");var g=("gutter-narrow"===c?1.6:"gutter-none"===c?0:3.2)-("gutter-narrow"===e?1.6:"gutter-none"===e?0:3.2),g=parseFloat(g*(a.length-1)/a.length);a.each(function(a){h(this).prop("style").width&&(a=parseFloat(h(this).prop("style").width)+g,h(this).css("width",a+"%"))})}else{var k={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,
"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,"col3-1":32.266,"col3-2":66.05},m={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};(a?a.children(".module_column").find(".tb_grid_drag"):h(".tb_grid_drag")).each(function(){var a,c,d,e,g=0,r,t=!1,u=0,x=!1,z,G,A,C=null,I=null,B;h(this).draggable({axis:"x",cursor:"col-resize",distance:0,scroll:!1,snap:!1,containment:".row_inner",helper:function(b){a=h(b.currentTarget);
c=a.closest(".subrow_inner");0===c.length&&(c=a.closest(".row_inner"));r=a[0].classList.contains("tb_drag_right")?"w":"e";z="w"===r?"tb_grid_drag_right_tooltip":"tb_grid_drag_left_tooltip";x=n.clone(c.closest(".module_row"));c.addClass("tb_drag_column_start");return h('<div class="ui-widget-header tb_grid_drag_tooltip '+z+'"></div><div class="ui-widget-header tb_grid_drag_tooltip"></div>')},start:function(b,f){d=c.children(".module_column");e=a.closest(".module_column");A=c[0].classList.contains("direction-rtl");
"w"===r?(t=A?e.prev(".module_column"):e.next(".module_column"),g=a.outerWidth(),B=e.outerWidth()):(t=A?e.next(".module_column"):e.prev(".module_column"),B=g=e.outerWidth());g=parseInt(g);u=parseInt(t.outerWidth())-2;G=c.outerWidth();C=e.addClass("tb_drag_column_current").children("."+z)[0];I=e.children(".tb_grid_drag_tooltip").last()[0]},stop:function(a,p){h(".tb_grid_drag_tooltip").remove();c.removeClass("tb_drag_column_start");var q=Math.ceil(100*(e.outerWidth()/G));e.removeClass("tb_drag_column_current").css("width",
q+"%");var n=k,q=3.2;c[0].classList.contains("gutter-narrow")?(n=l,q=1.6):c[0].classList.contains("gutter-none")&&(n=m,q=0);var w=q*(d.length-1);d.each(function(a){a!==t.index()&&(h(this).prop("style").width?a=parseFloat(h(this).prop("style").width):(a=h.trim(f.filterClass(h(this).attr("class")).replace("first","").replace("last","")),a=n[a]),w+=a)});t.css("width",100-w+"%");t=t.add(e);f.setCompactMode(t);var q=c.closest(".module_row"),y=!0===b.hasChanged;b.hasChanged=!0;b.undoManager.push(q.data("cid"),
x,q,"row");b.hasChanged=y;v.body.triggerHandler("tb_grid_changed",[q]);C=I=g=u=G=B=t=z=e=r=A=c=d=null},drag:function(a,b){if(t&&0<t.length){var c=parseInt(b.position.left),c=g+("e"===r?-c:c),d=parseFloat(100*c/G);if(5<=d&&100>d){var f=u,f=f+("w"===r?-(c-B):B-c),h=parseFloat(100*f/G);5<h&&100>h&&(t.css("width",f+"px"),e.css("width",c+"px"),C.innerHTML=d.toFixed(2)+"%",I.innerHTML=h.toFixed(2)+"%")}}}})})}},grid:function(a){var b=[];a=parseInt(a);if(1===a)b.push({grid_class:"col-full"});else for(var c=
0;c<a;++c)b.push({grid_class:"col"+a+"-1"});return[{cols:b}]},setCompactMode:function(a){a instanceof jQuery&&(a=a.get());for(var b=a.length-1;-1<b;--b)185>a[b].clientWidth?a[b].classList.add("compact-mode"):a[b].classList.remove("compact-mode")},initNewEditor:function(a){if(3<parseInt(tinyMCE.majorVersion)){var b=tinyMCEPreInit.mceInit.tb_lb_hidden_editor;b.elements=a;b.selector="#"+a;a=new tinyMCE.Editor(a,b,tinyMCE.EditorManager);a.render();return a}},initQuickTags:function(a){"function"===typeof u.QTags&&
(u.quicktags({id:a}),u.QTags._buttonsInit())},_getColClass:function(a){for(var b=0,c=a.length;b<c;++b)if(-1!==this.gridClass.indexOf(a[b]))return a[b].replace("col","")},saveBuilder:function(a,d,c){d=d||0;if(0===d){if(null!==b.activeModel||0<n.Lightbox.$lightbox.length&&n.Lightbox.$lightbox[0].classList.contains("tb_custom_css_lightbox")){var e=n.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];e!==t&&e.click();e=null}n.showLoader("show")}var f=Object.keys(b.Instances.Builder).length,
g=b.Instances.Builder[d],k=this,e=g.$el.data("postid"),g=b.Mixins.Builder.toJSON(g.el);if(!0===c)return{id:e,data:g};b.GS.setImport(b.GS.styles,null,null,!0);(function(a,c){null===A&&(A=themifyBuilder.custom_css,delete themifyBuilder.custom_css);var d={action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:a,custom_css:A,sourceEditor:"visual"===b.mode?"frontend":"backend"};k.saveCss(c,d.custom_css,d.id);d.data=JSON.stringify(b.Utils.clear(c));return h.ajax({type:"POST",url:themifyBuilder.ajaxurl,
cache:!1,data:d})})(e,g).always(function(c,e){++d;f===d?(h.isFunction(a)&&a.call(k,c,e),"success"!==e?n.showLoader("error"):(n.showLoader("hide"),b.editing=!0,v.body.triggerHandler("themify_builder_save_data",[c,e]))):setTimeout(function(){k.saveBuilder(a,d)},50)})},saveCss:function(a,d,c){return h.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:{css:JSON.stringify(b.GS.createCss(a,null,!0)),action:"tb_save_css",custom_css:d,tb_load_nonce:themifyBuilder.tb_load_nonce,id:c}})},loadContentJs:function(a,
d){ThemifyBuilderModuleJs.loadOnAjax(a,d);if(!1===b.saving){var c=h("audio.wp-audio-shortcode, video.wp-video-shortcode",a);0<c.length&&(v.mediaCssLoad(),c.each(function(){var a=h(this).closest(".mejs-mediaelement");0<a.length&&(this.removeAttribute("style"),this.setAttribute("id",this.getAttribute("id").replace("_html5","")),a.closest(".widget").html(this))}),c.mediaelementplayer(u.wpmejsSettings!==t?u.wpmejsSettings:{}))}v.body.triggerHandler("builder_load_module_partial",[a,d])},createClearBtn:function(a){a.siblings(".tb_clear_btn").click(function(){h(this).hide();
a.val("").trigger("keyup")})},toRGBA:function(a){return ThemifyStyles.toRGBA(a)},getColor:function(a){var b=a.value;""!==b&&(null!==a.getAttribute("data-minicolors-initialized")?b=h(a).minicolors("rgbaString"):(a=a.getAttribute("data-opacity"),""!==a&&null!==a&&"1"!=a&&"0.99"!=a&&(b=this.toRGBA(b+"_"+a))));return b},getIcon:function(a){var b=a.split("-")[0].trim();return"fa"===b||"ti"===b?b+" "+a:"fas fa"===b||"far fa"===b||"fab fa"===b?a:!1},getBPWidth:function(a){a=Array.isArray(themifyBuilder.breakpoints[a])?
themifyBuilder.breakpoints[a]:themifyBuilder.breakpoints[a].toString().split("-");return a[a.length-1]},transitionPrefix:function(){if(this.transitionPrefix.pre===t){var a=r.createElement("fakeelement"),b={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"},c;for(c in b)if(a.style[c]!==t){this.transitionPrefix.pre=b[c];break}}return this.transitionPrefix.pre},generateUniqueID:function(){return(Math.random().toString(36).substr(2,
4)+(new Date).getUTCMilliseconds().toString()).substr(0,7)},getUIDList:function(a){a=a||"row";var d=_.pluck(b.Models.Registry.items,"attributes");return _.where(d,{elType:a})||[]},scrollTo:function(a){("desktop"===b.activeBreakPoint?h("html,body"):h("body",u.document)).scrollTop(a)},scrollToDropped:function(a,d){a||(a=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_cid_"+d)[0]);if(a)if("visual"===b.mode)this.scrollTo(h(a).offset().top-120);else{var c=r.getElementsByClassName("edit-post-layout__content")[0];
if(c!==t){if(a.classList.contains("module_row"))var e=a.offsetTop;else e=a.closest(".module_row"),null!==e?(e=h(e),e=e.offset().top+200-e.offsetParent().offset().top):e=a.offsetTop;h(c).scrollTop(e)}}},addViewPortClass:function(a){a.style.transition="none";this.removeViewPortClass(a);var b=this.isInViewport(a);if(!1!==b)for(var b=b.split(" "),c=b.length-1;-1<c;--c)""!==b[c]&&a.classList.add(b[c]);a.style.transition=""},removeViewPortClass:function(a){for(var b=["top","left","bottom","right"],c=4;-1<
c;--c)a.classList.remove("tb_touch_"+b[c])},isInViewport:function(a){a=a.getBoundingClientRect();var b="";0>a.left?b="tb_touch_left":a.right-1>=r.documentElement.clientWidth&&(b="tb_touch_right");if(0>a.top)b+=" tb_touch_top";else if(a.bottom+1>=r.documentElement.clientHeight||x.innerHeight+x.scrollY>=r.body.offsetHeight&&a.bottom+20>=r.documentElement.clientHeight)b+=" tb_touch_bottom";return""===b?!1:b},checkImageSize:function(a){var b=a.getElementsByTagName("img")[0],c=function(c){b.width<c?a.classList.add("tb_disable_object_fit"):
a.classList.remove("tb_disable_object_fit")};if(b!==t){var e=b.naturalWidth;if(e&&b.complete)c(e);else{var f=new Image;f.onload=function(){c(f.width)};f.src=b.src}}else a.classList.remove("tb_disable_object_fit")},checkAllimageSize:function(){var a=b.Instances.Builder[b.builderIndex].el,d=b.Models.Registry.items,c;for(c in d)if("image"===d[c].attributes.mod_name){var e=a.getElementsByClassName("tb_element_cid_"+d[c].cid)[0];e!==t&&this.checkImageSize(e)}},hideOnClick:function(a){a[0]!==t&&(a=a[0]);
if(a.classList.contains("tb_ui_dropdown_items")||a.classList.contains("tb_down"))a.classList.add("tb_hide_option"),a.previousElementSibling.blur(),setTimeout(function(){a.classList.remove("tb_hide_option")},500)},calculateHeight:function(){"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&(u.document.body.style.height=r.body.scrollHeight+"px")},changeOptions:function(a,d){var c="INPUT"===a.tagName&&"hide_anchor"!==d?"keyup":"change",e=this;"keyup"===c&&a.setAttribute("data-prev",a.value);e.custom_css_id=
function(a,b,c,d){a=r.getElementById(d);return null===a||c[0].getAttribute("id")===d||null===a.closest(".module_row")?(c[0].setAttribute("id",d),!0):!1};e.row_anchor=function(a,c,d,e){"visual"===b.mode&&(d.removeClass(b.liveStylingInstance.getRowAnchorClass(a.getAttribute("data-prev"))),""!==e&&d.addClass(b.liveStylingInstance.getRowAnchorClass(e)),d.data("anchor",e).attr("data-anchor",e));b.hasChanged=!0;d.find(".tb_row_anchor").first().text(e.replace("#",""));return!0};e.custom_css=function(a,c,
d,e){"visual"===b.mode&&d.removeClass(a.getAttribute("data-prev")).addClass(e);return!0};e.layout=function(a,c,d,e){"visual"===b.mode&&b.liveStylingInstance.bindRowWidthHeight(c,e,d);return!0};e.hide_anchor=function(a,c,d,e){"visual"===b.mode&&"1"===e&&d.data("hideAnchor",e).attr("data-hide-anchor",e);return b.hasChanged=!0};a.addEventListener(c,function(a){var f=null!==b.activeModel&&b.ActionBar.cid===b.activeModel.cid,k=!n.Lightbox.$lightbox[0].contains(this),l="hide_anchor"!==d?this.id:"hide_anchor",
m="custom_css_id"===l,q=!0!==m||!1!==k&&!0!==f?t:n.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];var p=!0===k&&!1===f?h(".tb_element_cid_"+b.ActionBar.cid):"visual"===b.mode?b.liveStylingInstance.$liveStyledElmt:h(".tb_element_cid_"+b.activeModel.cid);var y=!1===f&&!0===k?n.clone(p[0]):null;var w=this.value;"keyup"===c&&"custom_css"!==d?((w=w.trim())&&(w=w.replace(/[^a-zA-Z0-9\-\_]+/gi,"")),this.value=w):"layout"===d?w=a.detail.val:"hide_anchor"===d&&(w=this.checked?"1":"0");
if(e[d].call(e,this,l,p,w)){m&&(h(this).next(".tb_field_error_msg").remove(),q!==t&&q.classList.remove("tb_disable_save"));if(!0===k){var u=function(){var a=w;"keyup"===c&&(this.removeEventListener("change",u,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),a=this.value.trim());var d=p.data("cid"),e=b.Models.Registry.lookup(d),f=h.extend(!0,{},e.get("styling"));f||(f={});var g=h.extend(!0,{},f);f[l]=a;e.set({styling:f},{silent:!0});null!==y&&b.undoManager.push(d,y,p,"save",{bsettings:g,asettings:h.extend(!0,
{},f)})};"keyup"===c?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",u,{passive:!0,once:!0})):u()}b.hasChanged=!0}else m&&(a=r.createElement("span"),a.className="tb_field_error_msg",a.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(a,this.nextSibling),q!==t&&q.classList.add("tb_disable_save"));!0===f&&(f=k?n.Lightbox.$lightbox.find("#"+l):h("#"+b.ActionBar.el.id).find("#"+l),"keyup"===c?f.val(w).attr("data-prev",w):"layout"===
d?(f.find(".selected").removeClass("selected"),""!==w?f.find("#"+w).addClass("selected"):f.children().first().addClass("selected")):"hide_anchor"===d&&(f.find("INPUT")[0].checked=this.checked));"keyup"===c&&this.setAttribute("data-prev",w)},{passive:!0})},visibilityLabel:function(a,d){var c=t===d?b.Models.Registry.lookup(a.getAttribute("data-cid")):null;d=t===d?"module"!==c.get("elType")?c.get("styling"):c.get("mod_settings"):d;if(null!==d){var c="",e={visibility_desktop:themifyBuilder.i18n.de,visibility_mobile:themifyBuilder.i18n.mo,
visibility_tablet:themifyBuilder.i18n.ta,visibility_tablet_landscape:themifyBuilder.i18n.ta_l,sticky_visibility:themifyBuilder.i18n.s_v},f=a.getElementsByClassName("tb_visibility_hint")[0];if(f!==t){if("hide_all"===d.visibility_all)c=themifyBuilder.i18n.h_a;else{var g;for(g in e){var h=""===c?"":", ";c+="hide"===d[g]?h+e[g]:""}}f.textContent=c}}}};b.ActionBar={cid:null,topH:null,type:null,disable:null,prevExpand:null,needClear:!0,el:null,breadCrumbs:null,breadCrumbsPath:{lightbox:null,rightClick:null},
disablePosition:null,isInit:null,isHoverMode:!0,hoverCid:null,contextMenu:null,contextMenuAnimate:null,init:function(){if(null===this.isInit&&!0!==b.GS.isGSPage){this.isInit=!0;this.el=r.createElement("div");this.breadCrumbs=r.createElement("ul");this.el.id="tb_component_bar";this.breadCrumbs.className="tb_action_breadcrumb";this.el.addEventListener("mousedown",this.mouseDown.bind(this));this.topH=b.toolbar.$el.height();"visual"===b.mode?r.body.appendChild(this.el):b.Instances.Builder[b.builderIndex].el.parentNode.appendChild(this.el);
r.addEventListener("click",this.click.bind(this));r.addEventListener("dblclick",this.click.bind(this));b.Instances.Builder[0].el.addEventListener("mouseover",this.enter);"visual"===b.mode&&u.document.addEventListener("click",this.click.bind(this));var a="visual"===b.mode?null:r.getElementById("tb_canvas_block");null===a?(r.addEventListener("keydown",this.actions.bind(this)),u.document.addEventListener("keydown",this.actions.bind(this))):a.addEventListener("keydown",this.actions.bind(this));this.changeMode();
this.initRightClick(!0)}},changeMode:function(){this.hoverCid=null;var a=this,b=function(b){a.actions(b)};!0===this.isHoverMode?(r.body.classList.remove("tb_click_mode"),r.body.classList.add("tb_hover_mode"),this.el.removeEventListener("click",b)):(r.body.classList.remove("tb_hover_mode"),r.body.classList.add("tb_click_mode"),this.el.addEventListener("click",b))},initRightClick:function(a){localStorage.getItem("tb_right_click")?!0===a?b.toolbar.el.getElementsByClassName("tb_right_click_mode")[0].checked=
!1:(b.Instances.Builder[0].el.removeEventListener("contextmenu",this.rightClick),this.contextMenu=this.contextMenuAnimate=null):(b.Instances.Builder[0].el.addEventListener("contextmenu",this.rightClick),b.ActionBar.el.removeEventListener("contextmenu",this.rightClick),!0!==this.isHoverMode&&b.ActionBar.el.addEventListener("contextmenu",this.rightClick))},enter:function(a){var d=b.ActionBar;b.Mixins.Builder.columnHover(a.target);if(!0===d.isHoverMode&&null===d.disablePosition&&null===d.disable){a.preventDefault();
a.stopPropagation();var c=a.target,e=null,f=c.classList;if(null!==d.prevExpand&&d.prevExpand!==t)if(d.prevExpand.contains(c)){if(f.contains("tb_inner_action_more")||f.contains("tb_action_more")){var g=c.getElementsByTagName("ul")[0];g!==t&&b.Utils.addViewPortClass(g)}g=d.prevExpand.getElementsByClassName("tb_row_settings")[0];if(g!==t){var k=r.getElementById(g.getAttribute("data-href"));if(k.contains(c))return;k.classList.remove("selected");g.classList.remove("selected")}if("module"===d.type||"column"===
d.type){"column"===d.type&&(d.hoverCid=c.parentNode.getAttribute("data-cid"));return}}else{g="module"!==d.type;if(!1===g)"visual"!==b.mode?(g=c.closest(".active_module"),g=null!==g?g.getAttribute("data-cid")!==d.hoverCid:!0):(k=c.closest(".tb_dragger_top"),null!==k&&k.classList.contains("tb_dragger_padding")&&b.EdgeDrag.setModulePosition(k));else if(f.contains("tb_clicked"))return;!0===g&&d.clear()}if(null===c.closest(".tb_dragger_lightbox")){if(f.contains("tb_action_wrap"))e=!f.contains("tb_clicked");
else{if("LI"===c.nodeName&&f.contains("tb_row_settings")&&!f.contains("selected")){d.actions(a);return}if(!f.contains("tb_grid_drag")){c=h(c).closest("[data-cid]")[0];if(c===t)return;f=c.getAttribute("data-cid");if(d.hoverCid===f)return;d.hoverCid=f;g=b.Models.Registry.lookup(f);f=g.get("elType");if("module"===f)e=!0;else if("visual"===b.mode){d.clear();b.EdgeDrag.addEdges(f,g,c);return}}}!0===e&&d.click(a)}}},rightClickGS:function(a,d,c){this.disable=!0;null!==b.activeModel&&h(".builder_save_button",
ThemifyBuilderCommon.Lightbox.$lightbox).click();var e=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_clicked"),f=b.GS.key;d=d.split(" ");for(var g=d.length,k=e.length-1;-1<k;--k){var l=b.Models.Registry.lookup(e[k].getAttribute("data-cid")),m=n.clone(e[k]),q="module"===l.get("elType")?"mod_settings":"styling",p=h.extend(!0,{},l.get(q)),r=h.extend(!0,{},p);b.activeModel=l;if(p[f])if(!0===c)a&&-1!==p[f].indexOf(a)&&(p[f]=p[f].split(" "),p[f].splice(p[f].indexOf(a),1),p[f]=
p[f].join(" "));else for(var t=0;t<g;++t)-1===p[f].indexOf(d[t])&&(p[f]+=" "+d[t]);else{if(0===g)continue;p[f]=d.join(" ")}t={};t[q]=p;l.set(t,{silent:!0});b.GS.generateValues(a,p[f].split(" "),c);b.undoManager.push(l.cid,m,h(e[k]),"save",{bsettings:r,asettings:p})}this.disable=null;b.activeModel=null},rightClick:function(a,d){a.stopImmediatePropagation();var c=b.ActionBar;if(null===c.contextMenuAnimate){c.contextMenuAnimate=!0;if(null===c.contextMenu){var e=function(a){a.stopPropagation();"click"===
a.type&&null===a.target.closest(".tb_visibility_wrap")&&a.preventDefault();if("LI"===a.target.nodeName||a.target.classList.contains("toggle_switch")){var d="LI"===a.target.nodeName?a.target.getAttribute("data-action"):"visibility";if(d){c.disable=!0;c.hoverCid=null;if("undo"===d||"redo"===d)if(a="undo"===d?b.undoManager.btnUndo:b.undoManager.btnRedo,"undo"===d&&b.undoManager.hasUndo()||"redo"===d&&b.undoManager.hasRedo())h(a).triggerHandler("click"),c.disable=null;else{c.disable=null;return}else{var e=
this.classList.contains("tb_multiply_selected");var f=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_clicked");var g=t;"gs_in"!==d&&"move"!==d&&(!0!==e||"delete"!==d&&"paste"!==d||(g=!0),h(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click());if("reset"===d){var k=b.activeModel;var l=h.extend(!0,{},ThemifyConstructor.values);var m=ThemifyConstructor.component;var p=ThemifyConstructor.beforeData;var q=!0===b.hasChanged;var r="visual"===b.mode?b.liveStylingInstance.prefix:
null;var u="visual"===b.mode?b.liveStylingInstance.$liveStyledElmt:null}else{if("move"===d){c.disable=null;return}if("gs_in"===d){if(!1===e){d=b.Models.Registry.lookup(f[0].dataset.cid);var y=h.extend(!0,{},ThemifyConstructor.values);ThemifyConstructor.values="module"===d.get("elType")?d.get("mod_settings"):d.get("styling")}if(d=b.GS.globalStylesHTML())a=c.contextMenu.querySelector("#tb_inline_gs"),a.innerHTML="",a.appendChild(d),a.getElementsByClassName("tb_gs_icon")[0].click(),a.querySelector('[data-action="insert"]').click(),
a.classList.add("tb_inline_gs_show"),b.Utils.addViewPortClass(c.contextMenu);!1===e&&(ThemifyConstructor.values=y);c.disable=null;return}}for(var v=f.length-1;-1<v;--v){e=f[v].getAttribute("data-cid");var x=b.Models.Registry.lookup(e);var z=x.get("elType");y="module"===z?x.get("mod_settings"):x.get("styling");if("reset"===d||"gs_r"===d){if("gs_r"!==d||y[b.GS.key]!==t){if(null!==b.activeModel&&b.activeModel.cid===e){var A=ThemifyBuilderCommon.Lightbox.$lightbox.find(".reset-styling")[0];if(A!==t){A.click();
continue}}var A=n.clone(f[v]),C;b.activeModel=x;"reset"===d&&(ThemifyConstructor.component=z,ThemifyConstructor.values=y);var F="module"===z?"mod_setting":"styling";"visual"===b.mode&&(b.liveStylingInstance.$liveStyledElmt?b.liveStylingInstance.prefix=ThemifyStyles.getBaseSelector("module"===z?b.activeModel.get("mod_name"):z,b.activeModel.get("element_id")):b.liveStylingInstance.init(!0),b.liveStylingInstance.$liveStyledElmt=h(f[v]));z=h.extend(!0,{},y);"reset"===d?(y=ThemifyConstructor.resetStyling(a,
null!==k&&k.cid!==e),"visual"===b.mode&&(C=h.extend(!0,{},y)),y=h.extend(!0,{},ThemifyConstructor.values)):(delete y[b.GS.key],b.GS.generateValues(null,[],!0));var J={};J[F]=y;x.set(J,{silent:!0});b.hasChanged=!0;b.undoManager.push(e,A,h(f[v]),"save",{bsettings:z,asettings:y,styles:C});C=null}}else("delete"!==d&&"visibility"!==d||"column"!==z)&&x.trigger(d,a,a.target,g)}"reset"===d?(b.hasChanged=q,b.activeModel=k,ThemifyConstructor.values=l,ThemifyConstructor.component=m,ThemifyConstructor.beforeData=
p,"visual"===b.mode&&(b.liveStylingInstance.$liveStyledElmt=u,b.liveStylingInstance.prefix=r)):"edit"!==d&&(b.activeModel=null);c.disable=null}"visibility"!==d&&c.hideContextMenu()}}},f=function(a){a.stopPropagation();a.target.classList.contains("tb_inner_action_more")&&(a=a.target.getElementsByTagName("ul")[0],a!==t&&b.Utils.addViewPortClass(a))};c.contextMenu=r.getElementById("tb_right_click");null===c.contextMenu&&(c.contextMenu=r.getElementById("tmpl-builder_right_click"),c.contextMenu=n.is_template_support?
c.contextMenu.content:c.contextMenu.innerHTML,n.is_template_support?r.body.appendChild(c.contextMenu):r.body.insertAdjacentHTML("beforeend",c.contextMenu),c.contextMenu=r.getElementById("tb_right_click"),c.contextMenu.addEventListener("click",e),c.contextMenu.addEventListener("mouseover",f,{passive:!0}),c.contextMenu.getElementsByClassName("tb_r_name")[0].addEventListener("mousedown",function(a){1!==a.which||c.contextMenu.classList.contains("tb_multiply_selected")||c.contextMenu.classList.contains("tb_component_column")||
(a.preventDefault(),a.stopPropagation(),a=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_clicked")[0],a!==t&&(c.hideContextMenu(),c.cid=a.dataset.cid,c.moveComponent()))}))}var g=!0;!0!==c.isHoverMode&&null!==c.cid?d=b.Instances.Builder[b.builderIndex].el.querySelector('[data-cid="'+c.cid+'"]'):d?g=!1:d=h(a.target).closest("[data-cid]")[0];if(d===t)c.contextMenuAnimate=null;else{a.preventDefault();c.hideContextMenu(a.target.classList.contains("tb_bread"));c.disablePosition=
!0;r.body.classList.add("tb_right_click_open");c.contextMenu.className="tb_show_context";var k=a.pageX,l=a.pageY,m=b.Models.Registry.lookup(d.dataset.cid),q=m.get("elType"),p=function(e){if("transform"===e.propertyName){var f=b.Instances.Builder[b.builderIndex].el;e=this.getElementsByClassName("tb_r_name")[0];var h=this.getElementsByClassName("tb_action_breadcrumb")[0],n=function(a){a.preventDefault();a.stopPropagation();var d=a.target.getAttribute("data-id");d&&(this.removeEventListener("click",
n),c.hideContextMenu(!0),d=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_cid_"+d)[0],d!==t&&c.rightClick(a,d))};this.removeEventListener("transitionend",p,{passive:!0});this.className="tb_component_"+q;"module"===q&&(this.className+=" tb_module_"+m.get("mod_name"));h.innerHTML="";if(!0===a.ctrlKey||!0===a.metaKey)d.classList.add("tb_element_clicked");else if(!d.classList.contains("tb_element_clicked")){var r=f.getElementsByClassName("tb_element_clicked");for(var u=r.length-
1;-1<u;--u)r[u].classList.remove("tb_element_clicked");d.classList.add("tb_element_clicked")}r=f.getElementsByClassName("tb_element_clicked").length;1<r?(this.className+=" tb_multiply_selected",e.textContent=themifyBuilder.i18n.multiSelected):(f=null===c.breadCrumbsPath.rightClick?m.cid:c.breadCrumbsPath.rightClick[c.breadCrumbsPath.rightClick.length-1],c.breadCrumbsPath.rightClick=c.getBreadCrumbPath(b.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+f)[0],"rightClick"),f=null,h.appendChild(c.getBreadCrumbs(d,
"rightClick")),e.textContent="module"===q?themifyBuilder.modules[m.get("mod_name")].name:q);h.addEventListener("click",n);var y=function(a){"transform"===a.propertyName?(this.removeEventListener("transitionend",y,{passive:!0}),b.Utils.addViewPortClass(this),c.contextMenuAnimate=null):(this.style.top=l+"px",!0===g&&(this.style.left=k+"px"))};this.addEventListener("transitionend",y,{passive:!0});b.undoManager.hasUndo()||(this.className+=" tb_undo_disabled");"column"===q&&(this.className+=" tb_visibility_disabled");
b.undoManager.hasRedo()||(this.className+=" tb_redo_disabled");this.className+=" tb_show_context"}};c.contextMenu.addEventListener("transitionend",p,{passive:!0});setTimeout(function(){c.contextMenu.className=""},18)}}},hideContextMenu:function(a){if(null!==this.contextMenu){this.contextMenu.style.top="";var d=this.contextMenu.querySelector("#tb_inline_gs");d.classList.contains("tb_inline_gs_show")&&d.classList.remove("tb_inline_gs_show");r.body.classList.remove("tb_right_click_open");this.disablePosition=
this.hoverCid=null;!0!==a&&(b.ActionBar.breadCrumbsPath.rightClick=null)}},mouseDown:function(a){1!==a.which||"row"!==this.type&&"subrow"!==this.type||!a.target.classList.contains("ti-move")||(a.preventDefault(),a.stopPropagation(),this.moveComponent())},moveComponent:function(){var a=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.cid)[0];if(a!==t){var d=a.classList.contains("module_row")?a.getElementsByClassName("tb_row_action")[0]:a,a=h(a).offset();this.clear();
if("function"===typeof Event)var c=new Event("mousedown",{bubbles:!0,cancelable:!1});else c=r.createEvent("Event"),c.initEvent("mousedown",!0,!1);c.pageX=a.left;c.pageY=a.top;c.which=1;d.dispatchEvent(c)}},click:function(a){if(b.isPreview||!0===this.disable)return!0;var d=a.target,c=d.tagName;var e=null;var f=b.Instances.Builder[b.builderIndex].lastRow;var g="visual"===b.mode&&d.ownerDocument===u.document?t:h(d).closest("[data-cid]")[0],k=a.type;if("click"===k){this.hideContextMenu();e=!0===a.ctrlKey||
!0===a.metaKey;if(u.document.body.classList.contains("tb_standalone_lightbox")&&!u.document.body.classList.contains("modal-open")){b.toolbar.el.contains(d)||n.Lightbox.$lightbox[0].contains(d)||n.Lightbox.$lightbox[0].classList.contains("tb_predesigned_lightbox")||n.Lightbox.close();var l=u.document.getElementsByClassName("tb_current_menu_selected")[0];l!==t&&l.classList.remove("tb_current_menu_selected");l=null}f&&!f.contains(d)&&f.classList.remove("expanded");if(!n.Lightbox.$lightbox[0].contains(d)&&
(!1===e&&this.clearClicked(),g!==t)){if(!0===e&&g.classList.contains("tb_element_clicked")){g.classList.remove("tb_element_clicked");return}g.classList.add("tb_element_clicked")}}else if("dblclick"===k&&null!==b.Forms.LayoutPart.id&&d.classList.contains("tb_overlay")){b.Forms.LayoutPart.save(a,!0);return}l=("click"===k||"dblclick"===k)&&"visual"===b.mode&&n.Lightbox.dockMode.get();if(g===t||!("dblclick"===k||!0===l&&d.classList.contains("tb_dragger"))&&d.classList.contains("tb_disable_sorting")||
g.classList.contains("tb_active_layout_part"))"LI"===c&&d.classList.contains("tb_bread")?(f=b.Models.Registry.lookup(d.getAttribute("data-id")),"setting"!==ThemifyConstructor.clicked&&"module"===ThemifyConstructor.component&&(a=n.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector(".current a").getAttribute("href"),n.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs").on("themify_opened_lightbox.tb_breadCrumbs",function(){"row"===ThemifyConstructor.component?
n.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector('a[href="'+this+'"]').click():null===b.activeModel&&n.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")}.bind(a)),a=null),a=null===this.breadCrumbsPath.lightbox?b.activeModel.cid:this.breadCrumbsPath.lightbox[this.breadCrumbsPath.lightbox.length-1],this.breadCrumbsPath.lightbox=this.getBreadCrumbPath(b.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+
a)[0]),a=null,f.trigger("edit","breadcrumb")):this.el.contains(d)||"click"===a.type&&d.classList.contains("tb_dragger")||this.clear();else{"visual"!==b.mode||"A"!==c&&null===d.closest("a")||a.preventDefault();var m=g.getAttribute("data-cid");f=b.Models.Registry.lookup(m);var q=f.get("elType"),p="row"===q&&g.classList.contains("tb-page-break");if(f){if("dblclick"===k){if((!0===l||"INPUT"===c||!0===p||d.classList.contains("tb_dragger_lightbox")||null!==d.closest(".tb_clicked"))&&"tb_row_options"!==
d.id)return;a.preventDefault();a.stopPropagation();!1===l&&!0!==this.isHoverMode?(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),"visual"===b.mode&&b.EdgeDrag.addEdges("module"===q?f.get("mod_name"):q,f,g)):g.classList.remove("tb_element_clicked");if(!d.classList.contains("tb_row_settings")){this.hoverCid=null;f.trigger("edit",a,d);return}}else if("click"===k&&!1===l&&(d.classList.contains("tb_dragger")||null!==d.closest(".tb_dragger_options")))return;var y=!0===
this.isHoverMode;var w=!0!==y&&null!==this.cid,c="module"!==q?d.classList.contains("tb_action_wrap"):!0===y;this.cid=m;this.type=q;if(!0===p&&"row"===q)this.clear(),d.classList.contains("tb_row_anchor")&&(a.preventDefault(),a.stopPropagation(),f.trigger("delete",a,d));else if((!1===c||"module"===q&&!0===y)&&null!==d.closest(".tb_action_wrap"))"click"===k&&this.actions(a);else if(!0===y&&"click"===k&&!0===this.needClear)!0===l&&!1===e&&f.trigger("edit",a,d);else if(this.clear(),!0===w&&"click"===k&&
!1===e&&!1===l&&!0===this.needClear){v.body[0].classList.add("tb_action_active");var x=this,z=function(){r.removeEventListener("mousemove",z,{passive:!0,once:!0});null===x.cid&&(v.body[0].classList.remove("tb_action_active"),x.clearClicked())};r.removeEventListener("mousemove",z,{passive:!0,once:!0});r.addEventListener("mousemove",z,{passive:!0,once:!0})}else{this.cid=m;this.type=q;e="tmpl-builder_"+q+"_action";k=n.is_template_support?r.getElementById(e).content.cloneNode(!0):n.templateCache.get(e);
if(!0===c){this.prevExpand="module"===q?g.getElementsByClassName("tb_module_action")[0]:d;if(this.prevExpand===t){this.clear();return}n.is_template_support?this.prevExpand.appendChild(k):this.prevExpand.insertAdjacentHTML("beforeend",k);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.style.top="";this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");!0===y&&"module"===q&&(k=!0,e=g.getBoundingClientRect(),70>e.height||200>e.width?(this.prevExpand.classList.add("tb_small_action_bar"),
this.prevExpand.classList.remove("tb_small_action_bar_top"),this.prevExpand.classList.remove("tb_small_action_bar_bottom"),this.prevExpand.style.top=0,40>this.prevExpand.getBoundingClientRect().top?(this.prevExpand.style.top="100%",this.prevExpand.classList.add("tb_small_action_bar_top")):this.prevExpand.classList.add("tb_small_action_bar_bottom"),70>e.height?this.prevExpand.classList.add("tb_small_action_bar_height"):this.prevExpand.classList.remove("tb_small_action_bar_height"),200>e.width?this.prevExpand.classList.add("tb_small_action_bar_width"):
this.prevExpand.classList.remove("tb_small_action_bar_width"),k=!1):this.prevExpand.classList.remove("tb_small_action_bar"),"visual"===b.mode&&(!0===k&&75>e.height&&(e=this.prevExpand.nextElementSibling,null!==e&&e.classList.contains("tb_module_btn_plus")&&null!==e.offsetParent||(e=g.parentNode.nextElementSibling),null!==e&&(e=this.prevExpand.getBoundingClientRect().bottom-e.getBoundingClientRect().top,0<=e&&(this.prevExpand.style.top=this.prevExpand.offsetTop-e-2+"px"))),b.EdgeDrag.addEdges(f.get("mod_name"),
f,g)))}else("row"!==q||"row"===q&&null!==this.breadCrumbsPath.lightbox)&&this.setBreadCrumbs(g),this.el.className="tb_show_toolbar tb_"+q+"_action",e=r.createElement("div"),e.className="tb_action_label_wrap",n.is_template_support?e.appendChild(k):e.insertAdjacentHTML("beforeend",k),"visual"===b.mode&&("module"===q?(k=f.get("mod_name"),this.el.className+=" tb_"+k+"_action",k=themifyBuilder.modules[k].name):(k=q,"row"===q&&(m=f.get("styling").row_anchor,m!==t&&(m=m.trim(),""!==m&&(k+=" #"+m)))),m=r.createElement("div"),
m.className="tb_data_mod_name",m.textContent=k.charAt(0).toUpperCase()+k.slice(1),e.appendChild(m)),this.el.appendChild(e);!0!==y&&(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),"visual"===b.mode&&b.EdgeDrag.addEdges("module"===q?f.get("mod_name"):q,f,g));if(!0===l&&(f.trigger("edit",a,d),!0===y||null!==this.disablePosition&&!1!==c&&!0===y))return;null===this.disablePosition&&(!1===c&&!0!==y?(f=a.pageX,y=a.pageY,"visual"!==b.mode&&(e=b.Instances.Builder[0].el.getBoundingClientRect(),
f=a.clientX-e.left,y=a.clientY-e.top+30),this.setPosition(this.el,{left:f,top:y})):b.Utils.addViewPortClass(this.prevExpand))}}else!0!==y&&this.clear()}},setBreadCrumbs:function(a){for(;null!==this.breadCrumbs.firstChild;)this.breadCrumbs.removeChild(this.breadCrumbs.firstChild);this.breadCrumbs.appendChild(this.getBreadCrumbs(a));null===this.el.firstChild?this.el.appendChild(this.breadCrumbs):this.el.insertBefore(this.breadCrumbs,this.el.firstChild)},getBreadCrumbPath:function(a,b){var c;b="rightClick"!==
b?"lightbox":b;var d=null!==this.breadCrumbsPath[b]?this.breadCrumbsPath[b]:[];if(0<d.length)return d;if(t!==a)for((c=a.getAttribute("data-cid"))&&d.push(c);!a.classList.contains("module_row");)a=a.parentNode,(c=a.getAttribute("data-cid"))&&d.push(c);return d},getBreadCrumbs:function(a,d){var c=this.getBreadCrumbPath(a,d),e=r.createDocumentFragment();if(t!==a)for(var f="rightClick"===d?a.dataset.cid:b.activeModel?b.activeModel.cid:b.ActionBar.cid,g=c.length-1;-1<g;--g){var h=r.createElement("li"),
l=b.Models.Registry.lookup(c[g]),m=l.get("elType");h.textContent="column"===m?l.get("component_name"):"module"===m?l.get("mod_name"):m;h.className="tb_bread tb_bread_"+m;f===c[g]&&(h.className+=" tb_active_bc");h.setAttribute("data-id",c[g]);e.appendChild(h)}return e},actions:function(a){var d=a.target;var c=d.tagName;if("keydown"===a.type){if("INPUT"!==c&&"TEXTAREA"!==c&&!themifyBuilder.disableShortcuts&&!n.Lightbox.$lightbox[0].contains(d)){var e=a.keyCode;c=r.getElementsByClassName("tb_element_clicked");
var f=c.length;if(0<f){a.preventDefault();a.stopPropagation();var g=null,k=null,l=t,m=!0===a.ctrlKey||!0===a.metaKey;46===e||8===e?g="delete":!0===m&&(67===e?(g="copy",f=1):68===e?g="duplicate":86===e&&(g="paste",!0===a.shiftKey&&(k="style")));1<f&&("delete"===g||"paste"===g)&&(l=!0,null!==b.activeModel&&n.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent());for(d=f-1;-1<d;--d){var q=c[d];if(null===g){if(!0===m&&1===f&&(38===e||40===e)){var p=38===a.which?"up":"down";var u="up"===
p?q.previousElementSibling:q.nextElementSibling;if(null!==u){if(q.classList.contains("module_row")){if(!u.classList.contains("module_row"))continue;var w=b.Instances.Builder[b.builderIndex].$el}else if(q.classList.contains("active_module")){if(!u.classList.contains("active_module"))continue;w=h(q.parentNode.closest(".tb_holder"))}else continue;u&&(u=h(q),w.sortable("option","beforeStart")(null,null,{item:u}),w.sortable("option","start")(null,{item:u}),"up"===p?u.prev().before(u):u.next().after(u),
w.sortable("option","update")({type:"sortupdate"},{item:u}),w.sortable("option","stop")(null,{item:u,helper:null}),!0!==this.isHoverMode&&q.classList.add("tb_element_clicked"))}}}else"delete"===g&&q.classList.contains("module_column")||(q=b.Models.Registry.lookup(h(q).closest("[data-cid]")[0].getAttribute("data-cid")),q.trigger(g,a,k,l))}"delete"!==g&&!0===this.isHoverMode||this.clear()}}}else if(a.stopPropagation(),"click"===a.type&&null!==d.closest(".switch-wrapper"))d.classList.contains("toggle_switch")&&
b.Models.Registry.lookup(h(d).closest("[data-cid]")[0].getAttribute("data-cid")).trigger("visibility",a,d);else if(a.preventDefault(),null!==this.cid&&("LI"===c||"SPAN"===c||"A"===c)&&(f=(e=d.classList.contains("tb_bread"))?d.getAttribute("data-id"):this.cid,p=null,q=b.Models.Registry.lookup(f),g=d.classList,q))if(v.body[0].classList.remove("tb_component_menu_active"),!0===e)this.needClear=null,this.disablePosition=!0,r.getElementsByClassName("tb_element_cid_"+f)[0].click(),this.disablePosition=null,
"visual"===b.mode&&(d=this.el.getBoundingClientRect(),d.right>=r.body.clientWidth&&this.setPosition(this.el,{left:d.left,top:this.el.offsetTop+55})),this.needClear=!0;else if(p=d.getAttribute("data-href"))for(a=d.parentNode.getElementsByTagName("li"),d=a.length-1;-1<d;--d)c=(q=a[d].getAttribute("data-href"))?r.getElementById(q):null,e=a[d].classList.contains("selected"),a[d].classList.remove("selected"),null!==c&&c.classList.remove("selected"),q!==p||e||("tb_row_options"===q||"tb_rgrids"===q?this.gridMenu(c):
"tb_roptions"===q&&0===c.children.length&&this.setRowOptions(c),c.classList.add("selected"),a[d].classList.add("selected"),b.Utils.addViewPortClass(c),v.body[0].classList.add("tb_component_menu_active"));else{if(g.contains("tb_edit")||g.contains("tb_styling")||g.contains("tb_visibility_component")||g.contains("tb_swap"))p="edit";else if(g.contains("tb_duplicate"))p="duplicate";else if(g.contains("tb_save_component"))p="save";else if(g.contains("tb_delete"))p="delete";else if(g.contains("ti-import")||
g.contains("ti-export"))p="importExport";else if(g.contains("tb_copy_component"))p="copy";else if(g.contains("tb_paste_component")||g.contains("tb_paste_style"))p="paste";else{if("LI"===c||"SPAN"===c||g.contains("tb_action_more")||g.contains("tb_inner_action_more")){a=d.closest("li");if(null===a)return;e=a.parentNode;p=e.classList;q=p.contains("tb_grid_list")||p.contains("tb_column_alignment")||p.contains("tb_column_gutter")||p.contains("tb_column_direction")||p.contains("tb_column_height")||p.contains("grid_tabs");
c=d.classList.contains("selected");e=e.children;if(q&&c)return;for(d=e.length-1;-1<d;--d)if(e[d].classList.remove("selected"),!1===q)for(f=e[d].getElementsByClassName("selected"),g=f.length-1;-1<g;--g)f[g].classList.remove("selected");c||(a.classList.add("selected"),v.body[0].classList.add("tb_component_menu_active"));if(q)p.contains("tb_column_alignment")?this._columnAlignmentClicked(a):p.contains("tb_column_gutter")?this._gutterChange(a):p.contains("tb_column_direction")?this._columnDirectionClicked(a):
p.contains("tb_column_height")?this._columnHeight(a):p.contains("grid_tabs")?this._switchGridTabs(a):p.contains("tb_grid_list")&&this._gridClicked(a);else{e=null!==this.prevExpand?this.prevExpand.children:this.el.getElementsByClassName("tb_action_label_wrap")[0].children;for(d=e.length-1;-1<d;--d)e[d].classList.remove("selected");c||null!==this.prevExpand&&"column"!==this.type||(e=a.getElementsByTagName("ul")[0],e!==t&&b.Utils.addViewPortClass(e))}}return}if(!0!==this.isHoverMode)this.clear();else{var x=
d.closest(".tb_action_more");null!==x&&(x=x.getElementsByTagName("ul")[0],x.style.display="none",setTimeout(function(){null!==x&&(x.style.display="")},100))}q.trigger(p,a,d)}},_switchGridTabs:function(a){b.ActionBar.disable=b.clearOnModeChange=!0;b.ActionBar.hoverCid=null;b.scrollTo=h(r.getElementsByClassName("tb_element_cid_"+this.cid)[0]);ThemifyConstructor.lightboxSwitch(a.getAttribute("data-id"));"visual"!==b.mode&&this.gridMenu(a.closest(".tb_toolbar_tabs"))},_gridClicked:function(a){var d=h(a),
c=d.data("grid"),e=this.type,f=h(".tb_element_cid_"+this.cid).first(),g=!1,k=b.activeBreakPoint,l="desktop"===k;a=n.clone(f.closest(".module_row"));g="subrow"===e;var m=f.find("."+e+"_inner").first();if(l){e=m;var q=d.data("col");e=e.add(h("#tb_rgrids"));q===t&&(q=1,d.data("col",q));for(k=6;0<k;--k)e.removeClass("col-count-"+k);e.addClass("col-count-"+q);m.attr("data-basecol",q);l&&d.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=h(this).find(".selected"),
b=h(this).data("type"),c=a.data("col");c!==t&&(c>q||4===q&&3===c||4<=q&&4<=c&&q!=c)&&(a.removeClass("selected"),m.removeClass("tb_grid_classes col-count-"+m.attr("data-basecol")+" "+m.attr("data-col_"+b)).attr("data-col_"+b,""),h(this).closest(".tb_grid_list").find("."+b+"-auto").addClass("selected"))})}else return"-auto"!==c[0]?(a="column"+c.join("-"),q=d.data("col"),3===q&&m.attr("data-basecol")>q&&(a+=" tb_3col"),m.removeClass(m.attr("data-col_tablet")+" "+m.attr("data-col_tablet_landscape")+" "+
m.attr("data-col_mobile")).addClass(a+" tb_grid_classes col-count-"+m.attr("data-basecol")).attr("data-col_"+k,a)):m.removeClass("tb_grid_classes tb_3col col-count-"+m.attr("data-basecol")+" "+m.attr("data-col_"+k)).attr("data-col_"+k,""),"visual"===b.mode&&(h("body",u.document).height(r.body.scrollHeight),b.Utils.calculateHeight()),b.Utils.setCompactMode(m.children(".module_column")),!1;d=m.children(".module_column");l=c.length;e="module_column"+(g?" sub_column":"")+" col";for(k=0;k<l;++k)f=d.eq(k),
0<f.length?f.removeClass(b.Utils.gridClass.join(" ")).addClass(e+c[k]):b.Utils._addNewColumn({newclass:e+c[k],component:g?"sub-column":"column"},m[0]);l<m.children().length&&m.children(".module_column").eq(l-1).nextAll().each(function(){h(this).find(".tb_holder").first().children().appendTo(h(this).prev().find(".tb_holder").first());h(this).remove()});c=m.children();c.removeClass("first last");m.hasClass("direction-rtl")?(c.last().addClass("first"),c.first().addClass("last")):(c.first().addClass("first"),
