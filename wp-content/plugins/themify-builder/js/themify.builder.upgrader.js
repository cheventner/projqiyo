...
(function ($, window, document, undefined) {
	...
	function tb_maintenance_mode(){
		var pagesDropdown = document.getElementById('tools_maintenance_page');
		...
		var maintenanceMode = document.getElementById('tools_maintenance_mode');
		if(null !== maintenanceMode){
			maintenanceMode.addEventListener('change',dependecy);
			dependecy();
		}
		function dependecy(){
			var checkbox = document.getElementById('tools_maintenance_mode'),
