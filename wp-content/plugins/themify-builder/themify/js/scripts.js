...
if ($source_element.length <= 0)
	...
	function tb_maintenance_mode(){
		...
		pagesDropdown.addEventListener('click',tb_load_maintenance_pages);
		function tb_load_maintenance_pages(){
			pagesDropdown.removeEventListener('click',tb_load_maintenance_pages);
			var self = this;
			$.ajax( {
				url: ajaxurl,
				type:'POST',
