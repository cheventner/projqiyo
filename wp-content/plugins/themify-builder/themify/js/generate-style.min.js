...
k||""===c[d.origId])return!1;"background-mode"===b?(c={repeat:"repeat","repeat-x":"repeat-x","repeat-y":"repeat-y","repeat-none":"no-repeat","no-repeat":"no-repeat",fullcover:"cover","best-fit-image":"contain","builder-parallax-scrolling":"cover","builder-zoom-scrolling":"100%","builder-zooming":"100%"},c[f]!==k&&(-1!==f.indexOf("repeat")?b="background-repeat":(b="background-size",e="background-repeat:no-repeat;","best-fit-image"===f||"builder-zooming"===f?e+="background-position:center center;":
"builder-zoom-scrolling"===f&&(e+="background-position:50%;")),f=c[f])):"background-repeat"===b&&"fullcover"===f&&(b="background-size",f="cover")}else if("column-count"===b){if("0"==f){b=[a,a+"_gap",a+"_divider_color",a+"_width",a+"_divider_style"];for(e=b.length-1;-1<e;--e)delete c[b[e]];return!1}(d=this.getStyleVal(a+"_gap",c))&&(e="column-gap:"+d+"px;");d=this.getStyleVal(a+"_divider_style",c);var g=this.getStyleVal(a+"_width",c);"none"===d?(delete c[a+"_divider_color"],delete c[a+"_width"],e+=
"column-rule:none;"):""===g||g===k?(delete c[a+"_divider_color"],delete c[a+"_width"],delete c[a+"_divider_style"]):(d||(d="solid"),e+="column-rule:"+g+"px "+d,c=this.getStyleVal(a+"_divider_color",c),""!==c&&c!==k&&(e+=" "+this.toRGBA(c)),e+=";")}else if("vertical-align"===b){if("inline-block"!==c[d.origID])return delete c[a],!1;""!==f&&!0!==this.saving&&k!==themifyBuilder&&(e+="align-self:"+("top"===f?"flex-start":"middle"===f?"center":"flex-end")+";")}else if(!0===d.display&&!0!==this.saving&&
k!==themifyBuilder){if("none"===f)return!1;e+="inline-block"===f?"width:auto;":"width:100%;"}return e+(b+":"+f+";")},position_box:function(a,b,d,c){b=d.prop;a=this.getStyleVal(a,c);if(a===k||""===a)return!1;if("background-position"===b){if(c[d.origId]===k||""===c[d.origId])return!1;-1!==a.indexOf("-")?a=a.replace("-"," "):(d=a.split(","),a=d[0]+"% "+d[1]+"%")}return""+(b+":"+a+";")},font_select:function(a,b,d,c){var e=c[a],f="";if("default"===e||""===e||e===k)return delete c[a],delete c[a+"_w"],!1;
b="undefined"!==typeof ThemifyConstructor&&ThemifyConstructor.font_select.google[e]!==k||"undefined"!==typeof ThemifyBuilderStyle&&ThemifyBuilderStyle.google[e]!==k;var g=!0===b?!1:"undefined"!==typeof ThemifyConstructor&&ThemifyConstructor.font_select.cf[e]!==k||"undefined"!==typeof ThemifyBuilderStyle&&ThemifyBuilderStyle.cf[e]!==k;b||g||(b="undefined"!==typeof themifyBuilder&&null!==themifyBuilder.google&&themifyBuilder.google[e]!==k,g=!0===b?!1:"undefined"!==typeof themifyBuilder&&null!==themifyBuilder.cf&&
themifyBuilder.cf[e]!==k);b||g?(a=c[a+"_w"],b=!0===b?"fonts":"cf_fonts",this[b][e]===k&&(this[b][e]=[]),a&&(f={normal:"normal",regular:400,italic:400,bold:700},-1===this[b][e].indexOf(a)&&this[b][e].push(f[a]!==k?f[a]:a),b=-1!==a.indexOf("italic")?";font-style:italic":"",a=f[a]!==k?f[a]:a.replace(/[^0-9]/g,""),f="font-weight:"+(a+b)+";")):delete c[a+"_w"];return f+=d.prop+":"+this.parseFontName(e)+";"},frame:function(a,b,d,c){return!1},range:function(a,b,d,c){if("column-gap"===d.prop||"column-rule-width"===
d.prop)return!1;b=this.getStyleVal(a,c);if(""===b||b===k)return delete c[a],delete c[a+"_unit"],!1;(a=this.getStyleVal(a+"_unit",c))||(a="px");return d.prop+":"+b+a+";"},radio:function(a,b,d,c){if("frame-custom"===d.prop){var e=a.split("-")[0];b=this.getStyleVal(a,c);a=b===e+"-presets"?this.getStyleVal(e+"-frame_layout",c):this.getStyleVal(e+"-frame_custom",c);if(!a||"none"===a)return a?"desktop"===this.breakpoint?!1:"background-image:none;":!1;var f="";if(b===e+"-presets"){if("left"===e||"right"===
e)a+="-l";var g=Themify.hash(a),h=this,m=function(a){var b=h.getStyleVal(e+"-frame_color",c);b!==k&&""!==b&&(a=a.replace(/\#D3D3D3/ig,h.toRGBA(b)));f='background-image:url("data:image/svg+xml;utf8,'+encodeURIComponent(a)+'");'};if(h.fields.frameCache[g]!==k)m(h.fields.frameCache[g]);else if(b=p.getElementById("tmpl-frame_"+a),null!==b)h.fields.frameCache[g]=b.textContent.trim(),m(h.fields.frameCache[g]);else{var l=new XMLHttpRequest;l.open("GET",(!0!==t&&"undefined"!==typeof themifyBuilder?themifyBuilder.builder_url:
tbLocalScript.builder_url)+("/img/row-frame/"+a+".svg"),!1);l.onreadystatechange=function(){4!==this.readyState||200!==this.status&&0!==l.status||(h.fields.frameCache[g]=this.responseText,m(this.responseText))};l.send(null)}}else f='background-image:url("'+a+'");';b=this.getStyleVal(e+"-frame_width",c);d=this.getStyleVal(e+"-frame_height",c);b?((a=this.getStyleVal(e+"-frame_width_unit",c))||(a="%"),f+="width:"+b+a+";"):(delete c[e+"-frame_width"],delete c[e+"-frame_width_unit"]);d?((a=this.getStyleVal(e+
...
""!==e&&e!==k?b+="column-gap:"+e+"px;":delete c[a+"_gap"],d?(e=this.getStyleVal(a+"_divider_style",c),a=this.getStyleVal(a+"_divider_color",c),b=b+("column-rule:"+d+"px ")+(e?e:"solid")+(""!==a&&a!==k?" "+this.toRGBA(a):""),b+=";"):(delete c[a+"_divider_color"],delete c[a+"_divider_width"],delete c[a+"_divider_style"])):(delete c[a],delete c[a+"_gap"],delete c[a+"_divider_color"],delete c[a+"_divider_width"],delete c[a+"_divider_style"]);return b},height:function(a,b,d,c){if("auto"===this.getStyleVal(a+
"_auto_height",c))a="height:auto;";else{b=this.getStyleVal(a,c);if(!b)return!1;(a=this.getStyleVal(a+"_unit",c))||(a="px");a="height:"+b+a+";"}return a},filters:function(a,b,d,c){a={hue:{unit:"deg",prop:"hue-rotate"},saturation:{unit:"%",prop:"saturate"},brightness:{unit:"%",prop:"brightness"},contrast:{unit:"%",prop:"contrast"},invert:{unit:"%",prop:"invert"},sepia:{unit:"%",prop:"sepia"},opacity:{unit:"%",prop:"opacity"},blur:{unit:"px",prop:"blur"}};b="";for(var e=Object.keys(a),f=0,g=e.length;f<
g;++f){var k=this.getStyleVal(d.id+"_"+e[f],c);k?b+=a[e[f]].prop+"("+k+a[e[f]].unit+") ":delete c[d.id+"_"+e[f]]}return""===b?!1:"filter:"+b+";"},text:function(a,b,d,c){a=this.getStyleVal(a,c);b=!1;a!==k&&""!==a&&(b=d.prop+":"+a+";");return b},number:function(a,b,d,c){return this.fields.text.call(this,a,b,d,c)},width:function(a,b,d,c){b=d.prop;d=this.getStyleVal(a,c);if("auto"===d)a="width:auto;";else{if(!d||"width"===b&&"auto"===this.getStyleVal(a+"_auto_width",c))return!1;(a=this.getStyleVal(a+
"_unit",c))||(a="px");a=b+":"+d+a+";"}return a},position:function(a,b,d,c){d=this.getStyleVal(a,c);if(""===d)return!1;b="position:"+d+";";if("absolute"===d||"fixed"===d){d=["top","right","bottom","left"];for(var e,f=d.length-1;0<=f;--f)e=this.getStyleVal(a+"_"+d[f]+"_auto",c),"auto"===e?e="auto":(e=this.getStyleVal(a+"_"+d[f],c),e=""===e||isNaN(e)?"":e+this.getStyleVal(a+"_"+d[f]+"_unit",c)),b+=""!==e?d[f]+":"+e+";":""}return b}},cleanUnusedStyles:function(a){for(f in a){var b=[];var d=h[f]!==k?h[f].type:
null;var c=function(a){if(""!==e){a=a.split("_");for(var b=[],c=0,d=a.length;c<d;++c)b.push(a[0]);return b.join("_")+"_"+e}return a};if("background_type"===f||"b_t_h"===f||"background_image"===f||"b_i_h"===f){if("background_image"===f||"b_i_h"===f){var e="b_i_h"===f?"h":"";if(a[c("background_image")])continue;else{var f="h"===e?"b_t_h":"background_type";a[f]="image"}}e="b_t_h"===f?"h":"";"gradient"!==a[f]?(b=c("background_gradient"),b=[b+"-circle-radial",b+"-gradient",b+"-gradient-angle",b+"-gradient-type"]):
b=[c("background_color")];"slider"!==a[f]&&(b.push(c("background_slider")),b.push(c("background_slider_size")),b.push(c("background_slider_mode")),b.push(c("background_slider_speed")));"video"!==a[f]&&(b.push("background_video_options"),b.push("background_video"));d=c("background_image");"image"===a[f]&&a[d]||("video"!==a[f]&&b.push(d),b.push(c("background_repeat")),b.push(c("background_zoom")),b.push(c("background_position")),b.push(c("background_attachment")));for(d=b.length-1;-1<d;--d)delete a[b[d]]}else if("background_attachment_inner"===
f||"b_a_i_h"===f){if(e="b_a_i_h"===f?"h":"",b=c("background_image_inner"),!a[b])for(b=[b,c("background_repeat_inner"),c("background_position_inner"),f],d=b.length-1;-1<d;--d)delete a[b[d]]}else if("cover_color-type"===f||"cover_color_hover-type"===f)for(c="cover_color_hover-type"===f,!0===c&&"hover_color"===a[f]||!1===c&&"color"===a[f]?(b="cover_gradient",!0===c&&(b+="_hover"),b=[b+"-circle-radial",b+"-gradient",b+"-gradient-angle",b+"-gradient-type"]):b=!0===c?["cover_color_hover"]:["cover_color"],
d=b.length-1;-1<d;--d)delete a[b[d]];else if("radio"===d&&-1!==f.indexOf("-frame_type"))for(c=f.replace("-frame_type",""),d=!1,a[f]===c+"-presets"?(b=[c+"-frame_custom"],d=!a[c+"-frame_layout"]||"none"===a[c+"-frame_layout"]):(b=[c+"-frame_layout"],b.push(c+"-frame_color"),d=!a[c+"-frame_custom"]),d&&(b.push(c+"-frame_color"),b.push(c+"-frame_width"),b.push(c+"-frame_width_unit"),b.push(c+"-frame_height"),b.push(c+"-frame_height_unit"),b.push(c+"-frame_repeat"),b.push(c+"-frame_location")),d=b.length-
1;-1<d;--d)delete a[b[d]];else if("background_image-type"===f||"b_i_h-type"===f)for(e="b_i_h-type"===f?"h":"",d=c("background_image"),"image"===a[f]&&(b=c("background_image"),b=[b+"-circle-radial",b+"-gradient",b+"-gradient-angle",b+"-gradient-type"]),"image"===a[f]&&a[d]||(b=[d,c("background_repeat"),c("background_position")],"image"!==a[f]&&b.push(c("background_color"))),d=b.length-1;-1<d;--d)delete a[b[d]];else if("multiColumns"===d&&-1!==f.indexOf("_count")){if(c=f.replace("_count",""),!a[c])for(b=
[c,c+"_gap",c+"_divider_color",c+"_divider_width",c+"_divider_style"],d=b.length-1;-1<d;--d)delete a[b[d]]}else if(a[f]&&-1!==f.indexOf("_apply_all")&&0===f.indexOf("checkbox_")){if(c=f.replace("_apply_all","").replace("checkbox_",""),h[c]!==k&&h[c].type===c)for(b=["right","bottom","left"],d=0;3>d;++d)delete a[c+"_"+b[d]]}else if("all"===a[f]&&-1!==f.indexOf("-type")){c=f.replace("-type","");var g=["color","style","width"],l=g.length;b=["right","bottom","left"];for(d=b.length-1;-1<d;--d)for(var m=
l-1;-1<m;--m)delete a[c+"_"+b[d]+"_"+g[m]]}else"element_font_weight"!==f&&"e_f_w_h"!==f||400!=a[f]?"font_select"!==d||a[f]&&"default"!==a[f]?-1!==f.indexOf("breakpoint_")&&(a[f]=this.cleanUnusedStyles(a[f])):(delete a[f],delete a[f+"_w"]):delete a[f]}return a}};if("undefined"!==typeof ThemifyBuilderStyle){var n=Object.keys(ThemifyBuilderStyle.points).reverse();n.push("desktop");ThemifyStyles.init(ThemifyBuilderStyle.styles,n);ThemifyBuilderStyle.styles=n=null;if(ThemifyBuilderStyle.google!==k){n=
ThemifyBuilderStyle.google;ThemifyBuilderStyle.google={};for(var l=n.length-1;-1<l;--l)""!==n[l].value&&"default"!==n[l].value&&(ThemifyBuilderStyle.google[n[l].value]={n:n[l].name,v:n[l].variant});n=null}if(ThemifyBuilderStyle.cf!==k){n=ThemifyBuilderStyle.cf;ThemifyBuilderStyle.cf={};for(l=n.length-1;-1<l;--l)""!==n[l].value&&"default"!==n[l].value&&(ThemifyBuilderStyle.cf[n[l].value]={n:n[l].name,v:n[l].variant});n=null}n=function(){var a;for(a in g)if(0===a.indexOf("themify_builder_data_")&&null!==
g[a]){var b=a.replace("themify_builder_data_","");ThemifyStyles.builder_id=b;var d=ThemifyStyles.createCss(g[a],null,!0,g["themify_builder_gs_"+b]),c={fonts:[],cf_fonts:[]},e=p.getElementById("themify_builder_content-"+b),f=p.createDocumentFragment();g[a]=null;if(d.gs!==k)for(var h in d.gs){var l=p.createElement("style");var m="";l.type="text/css";l.id="tb_temp_global_styles_"+b;if("desktop"!==h){var n=ThemifyBuilderStyle.points[h];"mobile"!==h&&(n=n[1]);l.media="screen and (max-width:"+n+"px)"}for(var t in d.gs[h])m+=
t+"{"+d.gs[h][t].join(" ")+"}";l.appendChild(p.createTextNode(m));f.appendChild(l)}for(h in d)if("gs"!==h)if("fonts"!==h&&"cf_fonts"!==h){l=p.createElement("style");m="";l.type="text/css";l.id="tb_temp_styles_"+b;"desktop"!==h&&(n=ThemifyBuilderStyle.points[h],"mobile"!==h&&(n=n[1]),l.media="screen and (max-width:"+n+"px)");for(t in d[h])m+=t+"{"+d[h][t].join(" ")+"}";l.appendChild(p.createTextNode(m));f.appendChild(l)}else for(t in d[h])n=t.split(" ").join("+"),0<d[h][t].length&&(n+=":"+d[h][t].join(",")),
c[h].push(n);n=Object.keys(c);for(m=n.length-1;0<=m;--m)0<c[n[m]].length?(l="fonts"===n[m]?"//fonts.googleapis.com/css?family="+c[n[m]].join("|")+"&subset=latin":tbLocalScript.cf_api_url+c[n[m]].join("|"),Themify.LoadCss(l,!1)):delete d[n[m]];p.head.appendChild(f);null!==e&&(e.style.visibility=e.style.opacity="",e.classList.remove("tb_generate_css"));c=new XMLHttpRequest;b={css:JSON.stringify(d),action:"tb_generate_on_fly",tb_load_nonce:ThemifyBuilderStyle.nonce,id:b};d="";for(h in b)""!==d&&(d+=
"&"),d+=encodeURIComponent(h)+"="+encodeURIComponent(b[h]);c.open("POST",ThemifyBuilderStyle.ajaxurl);c.responseType="json";c.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");c.send(d)}};p.addEventListener("DOMContentLoaded",n);p.addEventListener("tb_regenerate_css",n)}else if(g.themifyBuilder!==k){if(themifyBuilder.google!==k){n=themifyBuilder.google;themifyBuilder.google={};for(l=n.length-1;-1<l;--l)""!==n[l].value&&"default"!==n[l].value&&(themifyBuilder.google[n[l].value]=
{n:n[l].name,v:n[l].variant});n=null}if(themifyBuilder.cf!==k){n=themifyBuilder.cf;themifyBuilder.cf={};for(l=n.length-1;-1<l;--l)""!==n[l].value&&"default"!==n[l].value&&(themifyBuilder.cf[n[l].value]={n:n[l].name,v:n[l].variant});n=null}}})(window,document,void 0);
