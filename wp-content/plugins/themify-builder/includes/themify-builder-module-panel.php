...
$module_categories = array(
	...
	'addon'=>__('Addons','themify'),
	'site'=>__('Site','themify')
);
$module_categories = Themify_Builder_Model::remove_empty_module_categories(apply_filters( 'themify_module_categories', $module_categories ));
?>
<template id="tb_toolbar_template">
	...
	<div class="tb_toolbar_add_modules_wrap">
		...
		<div class="tb_module_panel_container<?php echo apply_filters('tb_toolbar_module', '') ?>">
			...
			<?php foreach ($module_categories as $class => $name): ?>
    			<div class="tb_module_panel_tab_acc tb_module_panel_tab_acc_component tb_cat_<?php echo $class ?>" >
                        <div class="tb_module_panel_tab_acc_title js-tb_module_panel_acc"><h4><?php echo $name; ?></h4></div>
